...
class MissionToopsDetails extends StatefulWidget {
  final Mission mission;
  MissionToopsDetails({Key key, this.mission}) : super(key: key);

  @override
  _MissionToopsDetailsState createState() => _MissionToopsDetailsState();
}

class _MissionToopsDetailsState extends State<MissionToopsDetails> {
  @override
